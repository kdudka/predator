/* obtained from http://isis.poly.edu/kulesh/stuff/src/klist/test_list.c
 *
 * originally written by Kulesh Shanmugasundaram
 */
...
#ifdef PREDATOR
    /* suppress the noise about calling of undefined functions */
#   define printf(...)
#   define scanf(...)
#endif
