# 1 "drivers/pci/pci-driver.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "drivers/pci/pci-driver.c"
# 11 "drivers/pci/pci-driver.c"
...
# 12 "include/linux/mod_devicetable.h" 2
...
# 135 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/ptrace.h"
struct cpuinfo_x86;
struct task_struct;
...
# 920 "include/linux/pci.h" 2
# 928 "include/linux/pci.h"
...
# 1222 "include/linux/pci.h"
# 1 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/pci.h" 1
...
# 5 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/pci.h" 2
...
# 7 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/pci.h" 2
...
# 59 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/pci.h"
extern unsigned long pci_mem_start;
...
# 106 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/pci.h"
...
# 1 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h" 1
# 9 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h"
...
# 10 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h" 2
...
# 12 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h" 2


# 1 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/swiotlb.h" 1
...
static inline __attribute__((always_inline)) void swiotlb_free(void) { }


extern void swiotlb_print_info(void);
# 5 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/swiotlb.h" 2
...
static inline __attribute__((always_inline)) int pci_swiotlb_detect(void)
{
 return 0;
}
...
# 15 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h" 2
...
# 16 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h" 2
# 25 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h"
...
# 44 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h" 2
         ...
         void *vaddr, dma_addr_t bus)
{
 ...
 ({ int __ret_warn_on = !!(({ unsigned long _flags; do { (_flags) = __raw_local_save_flags(); } while (0); raw_irqs_disabled_flags(_flags); })); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/dma-mapping.h", 155); __builtin_expect(!!(__ret_warn_on), 0); });
...
# 110 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/pci.h" 2
...
# 113 "/home/peringer/local/src/linux-2.6.35/arch/x86/include/asm/pci.h" 2
# 1223 "include/linux/pci.h" 2
# 1245 "include/linux/pci.h"
...
# 71 "include/linux/mempolicy.h" 2

struct mm_struct;
# 253 "include/linux/mempolicy.h"
struct mempolicy {};
...
static inline __attribute__((always_inline)) bool init_nodemask_of_mempolicy(nodemask_t *m) { return false; }
...
# 20 "drivers/pci/pci-driver.c" 2
# 1 "include/linux/pm_runtime.h" 1
# 75 "include/linux/pm_runtime.h"
static inline __attribute__((always_inline)) int pm_runtime_idle(struct device *dev) { return -38; }
static inline __attribute__((always_inline)) int pm_runtime_suspend(struct device *dev) { return -38; }
static inline __attribute__((always_inline)) int pm_runtime_resume(struct device *dev) { return 0; }
static inline __attribute__((always_inline)) int pm_request_idle(struct device *dev) { return -38; }
static inline __attribute__((always_inline)) int pm_schedule_suspend(struct device *dev, unsigned int delay)
{
 return -38;
}
static inline __attribute__((always_inline)) int pm_request_resume(struct device *dev) { return 0; }
static inline __attribute__((always_inline)) int __pm_runtime_get(struct device *dev, bool sync) { return 1; }
static inline __attribute__((always_inline)) int __pm_runtime_put(struct device *dev, bool sync) { return 0; }
static inline __attribute__((always_inline)) int __pm_runtime_set_status(struct device *dev,
         unsigned int status) { return 0; }
static inline __attribute__((always_inline)) int pm_runtime_barrier(struct device *dev) { return 0; }
static inline __attribute__((always_inline)) void pm_runtime_enable(struct device *dev) {}
static inline __attribute__((always_inline)) void __pm_runtime_disable(struct device *dev, bool c) {}
static inline __attribute__((always_inline)) void pm_runtime_allow(struct device *dev) {}
static inline __attribute__((always_inline)) void pm_runtime_forbid(struct device *dev) {}

static inline __attribute__((always_inline)) bool pm_children_suspended(struct device *dev) { return false; }
static inline __attribute__((always_inline)) void pm_suspend_ignore_children(struct device *dev, bool en) {}
...
static inline __attribute__((always_inline)) bool device_run_wake(struct device *dev) { return false; }
static inline __attribute__((always_inline)) void device_set_run_wake(struct device *dev, bool enable) {}
static inline __attribute__((always_inline)) bool pm_runtime_suspended(struct device *dev) { return false; }

static inline __attribute__((always_inline)) int pm_generic_runtime_idle(struct device *dev) { return 0; }
static inline __attribute__((always_inline)) int pm_generic_runtime_suspend(struct device *dev) { return 0; }
static inline __attribute__((always_inline)) int pm_generic_runtime_resume(struct device *dev) { return 0; }
...
# 21 "drivers/pci/pci-driver.c" 2
# 1 "drivers/pci/pci.h" 1
# 11 "drivers/pci/pci.h"
...
static inline __attribute__((always_inline)) bool pci_is_bridge(struct pci_dev *pci_dev)
{
...
static inline __attribute__((always_inline)) void pci_vpd_release(struct pci_dev *dev)
{
 if (dev->vpd)
...
static inline __attribute__((always_inline)) void pci_create_legacy_files(struct pci_bus *bus) { return; }
static inline __attribute__((always_inline)) void pci_remove_legacy_files(struct pci_bus *bus) { return; }
...
static inline __attribute__((always_inline)) void pci_msi_init_pci_dev(struct pci_dev *dev) { }
...
static inline __attribute__((always_inline)) int pci_ari_enabled(struct pci_bus *bus)
{
...
# 273 "drivers/pci/pci.h"
static inline __attribute__((always_inline)) int pci_iov_init(struct pci_dev *dev)
{
 return -19;
}
static inline __attribute__((always_inline)) void pci_iov_release(struct pci_dev *dev)

{
}
static inline __attribute__((always_inline)) int pci_iov_resource_bar(struct pci_dev *dev, int resno,
           enum pci_bar_type *type)
{
 return 0;
}
static inline __attribute__((always_inline)) void pci_restore_iov_state(struct pci_dev *dev)
{
}
static inline __attribute__((always_inline)) int pci_iov_bus_range(struct pci_bus *bus)
{
 return 0;
}

static inline __attribute__((always_inline)) int pci_enable_ats(struct pci_dev *dev, int ps)
{
 return -19;
}
static inline __attribute__((always_inline)) void pci_disable_ats(struct pci_dev *dev)
{
}
static inline __attribute__((always_inline)) int pci_ats_queue_depth(struct pci_dev *dev)
{
 return -19;
}
static inline __attribute__((always_inline)) int pci_ats_enabled(struct pci_dev *dev)
{
 return 0;
}


static inline __attribute__((always_inline)) int pci_resource_alignment(struct pci_dev *dev,
      struct resource *res)
{
...
# 22 "drivers/pci/pci-driver.c" 2

struct pci_dynid {
 struct list_head node;
 struct pci_device_id id;
};
# 49 "drivers/pci/pci-driver.c"
int pci_add_dynid(struct pci_driver *drv,
    unsigned int vendor, unsigned int device,
    unsigned int subvendor, unsigned int subdevice,
    unsigned int class, unsigned int class_mask,
...
store_new_id(struct device_driver *driver, const char *buf, size_t count)
{
 ...
 __u32 vendor, device, subvendor=(~0),
...
static struct driver_attribute driver_attr_new_id = { .attr = {.name = "new_id", .mode = 00200 }, .show = ((void *)0), .store = store_new_id, };
# 153 "drivers/pci/pci-driver.c"
static ssize_t
store_remove_id(struct device_driver *driver, const char *buf, size_t count)
{
 ...
 for (dynid = ({ const typeof( ((typeof(*dynid) *)0)->node ) *__mptr = ((&pdrv->dynids.list)->next); (typeof(*dynid) *)( (char *)__mptr - __builtin_offsetof(typeof(*dynid),node) );}), n = ({ const typeof( ((typeof(*dynid) *)0)->node ) *__mptr = (dynid->node.next); (typeof(*dynid) *)( (char *)__mptr - __builtin_offsetof(typeof(*dynid),node) );}); &dynid->node != (&pdrv->dynids.list); dynid = n, n = ({ const typeof( ((typeof(*n) *)0)->node ) *__mptr = (n->node.next); (typeof(*n) *)( (char *)__mptr - __builtin_offsetof(typeof(*n),node) );})) {
...
static struct driver_attribute driver_attr_remove_id = { .attr = {.name = "remove_id", .mode = 00200 }, .show = ((void *)0), .store = store_remove_id, };
     ...
     const struct pci_device_id *id)
{
 ...
 if (node >= 0) {
  ...
  do { } while (0);
  cpu = cpumask_next_and(-1, ((((void)node, cpu_online_mask))), ((cpu_online_mask)));
  if (cpu < 1)
...
static int pci_device_remove(struct device * dev)
{
 ...
 if (pci_dev->current_state == ((pci_power_t ) 0))
  pci_dev->current_state = ((pci_power_t ) 5);
# 393 "drivers/pci/pci-driver.c"
 pci_dev_put(pci_dev);
 return 0;
}
     ...
     const char *mod_name)
{
 ...
 do { spinlock_check(&drv->dynids.lock); do { *(&(&drv->dynids.lock)->rlock) = (raw_spinlock_t) { .raw_lock = { }, }; } while (0); } while (0);
...
# 1204 "drivers/pci/pci-driver.c"
void pci_dev_put(struct pci_dev *dev)
{
 if (dev)
  put_device(&dev->dev);
}
# 1217 "drivers/pci/pci-driver.c"
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) pci_driver_init(void)
{
 return bus_register(&pci_bus_type);
}

static initcall_t __initcall_pci_driver_init2 __attribute__((__used__)) __attribute__((__section__(".initcall" "2" ".init"))) = pci_driver_init;
