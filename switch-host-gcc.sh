...
usage() {
    ...
    plug-ins.  The recommended version of host GCC is 4.9.2 but Predator can be
    ...
    something like /usr/bin/gcc-4.9.2.  You can also provide a local build of
    GCC, e.g.  /home/bob/gcc-4.9.2/bin/gcc.  Please avoid setting GCC_HOST to
