...
usage() {
    ...
    plug-ins.  The currently supported version of host GCC is 4.8.0, but feel
    ...
    something like /usr/bin/gcc-4.8.0.  You can also provide a local build of
    GCC, e.g.  /home/bob/gcc-4.8.0/bin/gcc.  Please avoid setting GCC_HOST to
