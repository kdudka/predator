...
usage() {
    ...
    plug-ins.  The currently supported version of host GCC is 4.8.1, but feel
    ...
    something like /usr/bin/gcc-4.8.1.  You can also provide a local build of
    GCC, e.g.  /home/bob/gcc-4.8.1/bin/gcc.  Please avoid setting GCC_HOST to
