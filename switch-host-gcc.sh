...
usage() {
    ...
    plug-ins.  The recommended version of host GCC is 6.4.0 but Predator can be
    ...
    something like /usr/bin/gcc-6.4.0.  You can also provide a local build of
    GCC, e.g.  /home/bob/gcc-6.4.0/bin/gcc.  Please avoid setting GCC_HOST to
