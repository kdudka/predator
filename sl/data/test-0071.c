...
{
    struct item *shared_sls = create_slseg();
    struct master_item *item = create_master_item(NULL, shared_sls);
    item = create_master_item(item, shared_sls);
    item = create_master_item(item, shared_sls);
