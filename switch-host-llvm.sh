...
usage() {
    ...
    The most common location is /usr/lib/cmake/llvm or /usr/local/share/llvm/cmake.
    If you have multiple versions of Clang/LLVM installed on the system, it can
    be something like /usr/lib/cmake/llvm-3.8. You can also provide a local build,
